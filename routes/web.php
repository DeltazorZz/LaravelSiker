...
Route::get('/api/hardcovered/{hardcovered}', [CopyController::class, 'hardcovered']);
Route::get('/api/publication/{publication}', [CopyController::class, 'publicationCopyCount']);
Route::get('/api/status/', [CopyController::class, 'status']);
Route::get('/api/konyvdarab/{publication}/{book_id}', [CopyController::class, 'konyvDarab']);
Route::get('/api/hatodik/{book_id}', [CopyController::class, 'hatodik']);
